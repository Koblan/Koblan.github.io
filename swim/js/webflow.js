...
Webflow.require('ix').init([
  {"slug":"jump-ineraction","name":"Jump Ineraction","value":{"style":{},"triggers":[{"type":"load","loopA":true,"stepsA":[{"transition":"transform 800ms ease 0","x":"0px","y":"10px","z":"0px"},{"transition":"transform 800ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"slider-interaction","name":"Slider Interaction","value":{"style":{},"triggers":[{"type":"slider","stepsA":[{"opacity":1,"transition":"opacity 300ms ease 0, transform 300ms ease 0","scaleX":1,"scaleY":1,"scaleZ":1}],"stepsB":[{"opacity":0,"transition":"opacity 300ms ease 0, transform 300ms ease 0","scaleX":0.8,"scaleY":0.8,"scaleZ":1}]}]}},
  {"slug":"navbar-int","name":"Navbar Int","value":{"style":{},"triggers":[{"type":"scroll","selector":".fixed-navbar","preserve3d":true,"stepsA":[{"transition":"transform 300ms ease 0","x":"0px","y":"-300%","z":"0px"}],"stepsB":[{"background-color": "rgba(4, 43, 138, 0.702)"} , {"transition":"transform 300ms ease 0","x":"0px","y":"0px","z":"0px"}]}]}},
  {"slug":"nav-open","name":"nav open","value":{"style":{},"triggers":[{"type":"navbar","stepsA":[{"opacity":1,"transition":"opacity 300ms ease 0"}],"stepsB":[{"opacity":0,"transition":"opacity 300ms ease 0"}]}]}}
]);
/**
 * ----------------------------------------------------------------------
